...
| 16 | 学生实践手册 | 16.1 教学常见问题 / 16.2 Commit 规范 / 16.3 开发环境搭建 |
...
| 仓库 | 地址 | 用途说明 |
|------|------|----------|
| 课程主仓库 | `roboticsystem/OA-EPP` | 本课程项目仓库，必须 Star |
| Reflex 框架 | `reflex-dev/reflex` | 课程使用的全栈 Python 框架 |
| GitHub Copilot 文档 | `github/copilot-docs` | Copilot 官方使用文档 |
| copilot-enhance | `copilot-enhance/copilot-enhance-tool` | Superpowers 循环协作插件 |
| HackLLM Memory | `hacklm/hacklm-memory` | 跨会话 AI 记忆扩展 |
| MkDocs Material | `squidfunk/mkdocs-material` | 本课程文档站主题 |
| PlantUML | `plantuml/plantuml` | UML 图表工具（需求/设计文档使用） |
| Playwright Python | `microsoft/playwright-python` | UI 测试框架 |
| Ruff | `astral-sh/ruff` | Python 代码风格检查工具 |
| Alembic | `sqlalchemy/alembic` | 数据库迁移工具 |
