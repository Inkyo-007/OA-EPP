...
- 系统内置三套提示词模版：通用代码审查、工程实践规范检查、安全齐全审查。
- 用户可在高级设置页面编辑任意模版内容，并保存为自定义模版（带名称 + 描述）。
- 自定义模版可设为默认，从d 下次 PR 自动审查时使用该模版。
...
> 此表是整个系统的核心基础数据。所有基于 GitHub 活动（提交、PR、审查）的得分和统计均依赖此表将真实人身与 GitHub 造误映射。
...
- 对于未登记真实姓名的账号，系统显示警告并可一键发送提醒稺信将学生 GitHub 账号注册姓名的说明链接。
...
| 25 | F-D-007 | PR 审查与提示词模板管理（pr-agent） | 300 | ★★★★☆ |
...
> - 难度系数：★☆☆☆☆ 极简 / ★★☆☆☆ 简单 / ★★★☆☆ 中等 / ★★★★☆ 较难 / ★★★★★ 高难
> - 总计 32 项功能，预估总代码量约 **5,745 行**，平均难度系数约 **★★★☆☆**。
